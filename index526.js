...
function changeLinkText(lnk) {
    ...
    if (lnk =="home"){
        ...
        document.getElementById('divRight').innerHTML = "home link clicked. defualt text displayed";
        document.getElementById('ls_Heading').innerHTML = "ITC-111";
        document.getElementById('rs_Heading').innerHTML = "ntro to Programming <br>w/HTML, CSS & JavaScript";
        ...
        document.getElementById('divLeft_ALinks').style.display = "none";
        document.getElementById('divLeft_RLinks').style.display = "none";
        document.getElementById('divRight').innerHTML = "default describtion for class excercise links";
